...
int main(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, burst_len_Pin, 0);
  HAL_GPIO_WritePin(GPIOC, addr_in_Pin, 0);
  HAL_GPIO_WritePin(GPIOA, data_in_Pin, 0);
  HAL_GPIO_WritePin(GPIOA, rws_0_Pin, 0);
  HAL_GPIO_WritePin(GPIOA, rws_1_Pin, 0);
  HAL_GPIO_WritePin(GPIOA, rws_2_Pin, 0);
  HAL_Delay(100);
  ...
  // Single write data 0xffff at addr 0x0
  HAL_GPIO_WritePin(GPIOC, clk_Pin, 0);
  ...
  HAL_GPIO_WritePin(GPIOA, rws_2_Pin, 1);
  HAL_Delay(100);
  ...
  for (int i = 0; i < 16; i++){
	  ...
	  HAL_Delay(100);
	  HAL_GPIO_WritePin(GPIOC, clk_Pin, 1);
	  read_data[i] = HAL_GPIO_ReadPin(GPIOC, ser_data_in_Pin);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, data_in_Pin|rws_1_Pin|rws_2_Pin|rws_0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, addr_in_Pin|mode_sel_Pin|rst_Pin|clk_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, burst_en_Pin|burst_len_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : data_in_Pin rws_1_Pin rws_2_Pin rws_0_Pin */
  GPIO_InitStruct.Pin = data_in_Pin|rws_1_Pin|rws_2_Pin|rws_0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : ser_data_in_Pin */
  GPIO_InitStruct.Pin = ser_data_in_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ser_data_in_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : burst_en_Pin burst_len_Pin */
  GPIO_InitStruct.Pin = burst_en_Pin|burst_len_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
