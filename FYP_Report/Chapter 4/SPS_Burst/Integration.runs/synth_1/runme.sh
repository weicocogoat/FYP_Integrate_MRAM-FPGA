...
HD_PWD='C:/Users/yeohw/OneDrive/Desktop/FYP/Integration/Integration.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Integrate_Top_Module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Integrate_Top_Module.tcl
